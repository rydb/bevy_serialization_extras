...
use bevy_synonomize::plugins::SerializeAssetFor;
use bevy_synonomize::prelude::material::Material3dFlag;
use bevy_synonomize::prelude::mesh::Mesh3dFlag;
use bevy_synonomize::prelude::ComponentsOnSave;
use bevy_synonomize::prelude::RefreshCounter;
use bevy_synonomize::prelude::ShowSerializable;
use bevy_synonomize::prelude::ShowUnserializable;
use bevy_synonomize::prelude::TypeRegistryOnSave;
use bevy_synonomize::prelude::WrapAssetDeserializers;
use bevy_synonomize::prelude::WrapAssetSerializers;
use bevy_synonomize::prelude::WrapCompDeserializers;
use bevy_synonomize::prelude::WrapCompSerializers;
...
impl Plugin for SerializationBasePlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(SerializeAssetFor::<Material3dFlag>::default())
